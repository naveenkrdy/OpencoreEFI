 ...
 *
 * Disassembly of /Users/naveen/Desktop/ACPI Tables/SSDT-4-ADebTabl.aml, Thu Jun 25 03:37:49 2020
 *
...
DefinitionBlock ("", "SSDT", 2, "Intel ", "ADebTabl", 0x00001000)
{
    Scope (\)
    {
        Name (DPTR, 0x6D294000)
        Name (EPTR, 0x6D2A4000)
        Name (CPTR, 0x6D294020)
        Mutex (MMUT, 0x00)
