 ...
 *
 * Disassembly of /Users/naveen/Desktop/origin/DSDT.aml, Sun Jun 28 19:51:02 2020
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x00007095 (28821)
 *     Revision         0x02
 *     Checksum         0x0B
 *     OEM ID           "ALASKA"
 *     OEM Table ID     "A M I"
    ...
    Scope (_GPE)
    {
        ...
        Method (_L05, 0, NotSerialized)  // _Lxx: Level-Triggered GPE, xx=0x00-0xFF
        {
            ...
            If ((TSNE != 0xFF))
            {
                ...
                If ((TSNE && 0x02))
                {
                    Local0 = \_SB.GNVS (0x8388)
                    Name (_T_0, Zero)  // _T_x: Emitted by ASL Compiler, x=0-9, A-Z
                    _T_0 = Local0
                    If ((_T_0 == 0x02))
                    {
                        Notify (\_SB.PCI0.PC02, Zero) // Bus Check
                    }
                    ElseIf ((_T_0 == 0x03))
                    {
                        Notify (\_SB.PCI0.PC03, Zero) // Bus Check
                    }
                    ElseIf ((_T_0 == 0x04))
                    {
                        Notify (\_SB.PCI0.PC04, Zero) // Bus Check
                    }
                    ElseIf ((_T_0 == 0x0A))
                    {
                        Notify (\_SB.PCI0.PC0A, Zero) // Bus Check
                    }
                    ElseIf ((_T_0 == 0x0B))
                    {
                        Notify (\_SB.PCI0.PC0B, Zero) // Bus Check
                    }
                    ElseIf ((_T_0 == 0x0C))
                    {
                        Notify (\_SB.PCI0.PC0C, Zero) // Bus Check
                    }
                    ElseIf ((_T_0 == 0x0D))
                    {
                        Notify (\_SB.PCI0.PC0D, Zero) // Bus Check
                    }
                    ElseIf ((_T_0 == 0x15))
                    {
